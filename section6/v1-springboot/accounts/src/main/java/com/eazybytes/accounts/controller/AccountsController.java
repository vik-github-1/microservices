...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "Rest Api to  get the build info of AccountsMicroservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Rest Api to  get the java version in AccountsMicroservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Contact info details in AccountsMicroservice that can be reached out in case of any issues"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
