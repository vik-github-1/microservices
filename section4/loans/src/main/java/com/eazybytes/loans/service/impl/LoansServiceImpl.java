...
public class LoansServiceImpl implements ILoansService {
    ...
    private Loans createNewLoan(String mobileNumber){
        ...
        long loanNumber = 100000000000L +new Random().nextLong(900000000000L);
    ...
    public LoansDto fetchLoan(String mobileNumber) {
        Optional<Loans> loans= Optional.of(loansRepository.findByMobileNumber(mobileNumber).orElseThrow(() -> new ResourceNotFoundException("Loans", "mobileNumber", mobileNumber)));
        LoansDto loansDto =LoansMapper.mapToLoansDto(new LoansDto(),loans.get());
        return loansDto;
    }

    @Override
    public boolean updateLoan(LoansDto loansDto) {
        Optional<Loans> optionalLoans= Optional.of(loansRepository.findByLoanNumber(loansDto.getLoanNumber()).orElseThrow(() -> new ResourceNotFoundException("Loans", "loanNumber", loansDto.getLoanNumber())));
